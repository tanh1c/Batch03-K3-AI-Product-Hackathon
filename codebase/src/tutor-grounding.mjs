export function buildTutorPrompt({
  ...
  const instructions = [
    ...
    "Nếu người học hỏi định nghĩa, ý nghĩa hoặc ví dụ của một thuật ngữ có trong tài liệu nhưng tài liệu chưa giải thích đủ, bạn được dùng kiến thức nền ổn định để giải thích.",
    ...
    "Chỉ khi câu hỏi không liên quan đến nội dung trong ngữ cảnh hoặc đoạn đã chọn mới nói tài liệu không đủ căn cứ.",
